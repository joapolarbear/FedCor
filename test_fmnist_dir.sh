...
python3 main.py --gpu=0 --dataset=fmnist --model=mlp --mlp_layer 64 30  --epochs=500 --num_user=$NUM_CLIENT_PER_ROUND \
...
python3 main.py --gpu=0 --gpr_gpu=0 --dataset=fmnist --model=mlp --mlp_layer 64 30  \
    --epochs=500 --num_user=$NUM_CLIENT_PER_ROUND --alpha=0.2 --frac=0.05 --local_ep=3 --local_bs=64 --lr=5e-3 \
